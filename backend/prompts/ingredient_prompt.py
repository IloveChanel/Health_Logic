...
Assume the app uses this output for:
- ingredient explanations
- red flags
- personalized scoring
- beauty and food profile matching
- storing learned ingredient knowledge in a backend database
...
- personalized_flags must reflect the supplied user profile context.
- If the ingredient is unknown, still return best-effort JSON and explain uncertainty.
- Do not hallucinate regulatory approvals, disease treatment claims, or certainty you do not have.
'''
